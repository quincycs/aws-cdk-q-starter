...
import { IListenerCertificate, INetworkLoadBalancer, NetworkListener, NetworkLoadBalancer, NetworkTargetGroup } from 'aws-cdk-lib/aws-elasticloadbalancingv2';
...
export interface NetworkLoadBalancedServiceBaseProps {
   ...
   * @stability stable
   */
  readonly loadBalancerCertificates?: IListenerCertificate[];
...
export abstract class NetworkLoadBalancedServiceBase extends Construct {
  ...
  constructor(scope: Construct, id: string, props: NetworkLoadBalancedServiceBaseProps = {}) {
    ...
    this.listener = loadBalancer.addListener('Listener', {
      port: listenerPort,
      certificates: props.loadBalancerCertificates
    });
